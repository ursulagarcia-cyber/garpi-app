              ...
              <Box title="PARÁMETROS OPERATIVOS">
                <table style={{width:"100%",borderCollapse:"collapse",fontSize:13}}>
                  ...
                  <tbody>{[["Temp. acumulación ACS","tAC","tAR"],["Temp. impulsión primario","tIC","tIR"],["Temp. retorno ACS","tRC","tRR"]].map(([lbl,k1,k2])=>(
                    <tr key={lbl}><td style={{padding:"5px 8px",border:"0.5px solid #ddd"}}>{lbl}</td><td style={{padding:"4px 6px",border:"0.5px solid #ddd"}}><input defaultValue={mf[k1]} onBlur={e=>setMf(f=>({...f,[k1]:e.target.value}))} style={{width:"100%",border:"none",outline:"1px solid #eee",fontSize:13,textAlign:"center",background:"#fff",borderRadius:3,color:"#000"}}/></td><td style={{padding:"4px 6px",border:"0.5px solid #ddd"}}><input value={mf[k2]} onChange={e=>setMf(f=>({...f,[k2]:e.target.value}))} style={{width:"100%",border:"none",outline:"none",fontSize:13,textAlign:"center",background:"transparent"}}/></td></tr>
                  ))}</tbody>
                </table>
              </Box>
